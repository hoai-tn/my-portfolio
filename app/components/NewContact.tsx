    ...
    <section id="contact" className="section">
      <div className="max-w-2xl mx-auto text-center">
        <p className="text-[var(--accent-primary)] text-base font-mono mb-6">
          <span className="text-[var(--accent-primary)] font-mono text-lg mr-2">03.</span>
          What&apos;s Next?
        </p>
      ...
      <footer className="mt-32 text-center">
        <Card className="bg-[var(--glass-bg)] border-[var(--glass-border)] backdrop-blur-sm mx-auto max-w-md">
          <CardContent className="p-6">
            <div className="flex flex-col items-center gap-4">
              <div className="flex gap-6 mb-4 lg:hidden">
                <a
              ...
              <p className="text-[var(--text-muted)] text-sm font-mono">
                Designed & Built by <span className="text-[var(--accent-primary)]">Hoai Tran</span>
              </p>
