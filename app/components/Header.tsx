    ...
    <div className="flex flex-col-reverse md:grid md:grid-cols-12 my-[30px] md:py-[100px]">
      <div className="md:col-span-8 md:pr-[100px]">
        ...
        <p>
          ...
          not satisfied with my skill and working hard towards a higher skill. I
          have been developing web applications for over 4 years. I aim to make
          high-quality works with 100% effort for all customers.
        </p>
